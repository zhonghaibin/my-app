                ...
                <div class="w-full mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg" xmlns="http://www.w3.org/1999/html">
                    <form method="POST" action="{{route('article.save')}}" >
                        ...
                        <div>
                            ...
                            <x-input id="title" class="block mt-1 w-full" type="text" name="title"  required autofocus autocomplete="标题" />
                        </div>
                        <div>
                            <x-label for="subtitle" value="副标题" />
                            <x-input id="subtitle" class="block mt-1 w-full" type="text" name="subtitle"  required autofocus autocomplete="副标题" />
                        </div>
                        <div>
