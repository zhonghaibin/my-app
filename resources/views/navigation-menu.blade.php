<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="/" wire:navigate class="content-title flex align-middle text-gray-800 text-3xl justify-center  items-center relative">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @if (Route::has('login'))
            @auth
                <x-responsive-nav-link wire:navigate href="{{ route('dashboard') }}">{{ __('Dashboard') }}</x-responsive-nav-link>
                    ...
                    <div class="mt-3 space-y-1">
                        ...
                        @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                            ...
                            @if (Auth::user()->allTeams()->count() > 1)
                                ...
                                @foreach (Auth::user()->allTeams() as $team)
                                    <x-switchable-team wire:navigate :team="$team" component="responsive-nav-link" />
                                @endforeach
                            @endif
                        @endif
                    </div>
            ...
            @else
                <x-responsive-nav-link wire:navigate href="{{ route('login') }}">{{ __('Login') }}</x-responsive-nav-link>
                @if (Route::has('register'))
                    <x-responsive-nav-link wire:navigate href="{{ route('register') }}">{{ __('Register') }}</x-responsive-nav-link>
                @endif
            @endauth
        @endif
